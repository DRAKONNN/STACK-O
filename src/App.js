...
function Game(props) {
  ...
  return (
    <div key={game.id} className="col-lg-6">
    <div className={`${game.classAttBackground} me-md-3 pt-3 px-3 pt-md-3 px-md-5 text-center text-white overflow-hidden rounded-3`}>
        ...
        <div className="collapse navbar-collapse" id="collapseNavbar">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item custom-range">
              <p className="navbar-text mb-0"><i className="fas fa-users"></i> Players: {numberPlayers}</p>
            ...
            <li className="nav-item custom-range">
            <p className="navbar-text mb-0"><i className="fas fa-clock"></i> Minutes: {selectedDuration}</p>
